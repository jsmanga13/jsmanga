...
const PRODUCTS = [
  { sku: 'SKU-101', slug: 'kaoru-hana-vol-4', title: 'The Fragrant Flower Blooms with Dignity — Vol. 4', category: 'shounen', price: 28.00, img: 'images/4.jpg', kicker: 'Shounen · Drama · Limited Print', desc: 'The volume 4 cover art, reprinted at 18×24" on matte archival stock. A quiet composition that trusts negative space as much as linework.' },
  { sku: 'SKU-102', slug: 'kaoru-hana-meeting-family', title: 'The Fragrant Flower Blooms with Dignity — Meeting the Family', category: 'shounen', price: 26.00, img: 'images/meeting.jpg', kicker: 'Shounen · Drama · Limited Print', desc: "The chapter spread where Rintaro meets Kaoruko's family, reprinted at 18×24\" — the quiet tension of the scene holds up printed large." },
  { sku: 'SKU-103', slug: 'kaoru-hana-kaoruko-waguri', title: 'The Fragrant Flower Blooms with Dignity — Kaoruko Waguri', category: 'shounen', price: 30.00, img: 'images/rinka.jpg', kicker: 'Shounen · Drama · Limited Print', desc: 'A character-focused print of Kaoruko Waguri, reprinted at 18×24" on matte archival stock.' },
  ...
  { sku: 'SKU-105', slug: 'one-piece-wano-gear-5', title: 'One Piece — Wano, Gear 5', category: 'shounen', price: 34.00, img: 'images/overdfue.jpg', kicker: 'Shounen · Adventure · Limited Print', desc: 'The Gear 5 reveal from the Wano arc, reprinted at 18×24" — the hype moment, framed.' },
  { sku: 'SKU-106', slug: 'reborn-vongola-ensemble', title: 'Katekyo Hitman Reborn! — Vongola Ensemble', category: 'non-manga', price: 29.00, img: 'images/r1.jpg', kicker: 'Non-Manga · Illustration · Limited Print', desc: 'The full Vongola family ensemble, reprinted at 18×24" on matte archival stock.' },
  { sku: 'SKU-107', slug: 'reborn-battle-colors', title: 'Katekyo Hitman Reborn! — Battle Colors', category: 'non-manga', price: 27.00, img: 'images/r2.jpg', kicker: 'Non-Manga · Illustration · Limited Print', desc: 'Battle-colors art from the Vongola/Varia conflict, reprinted at 18×24" on matte archival stock.' },
  ...
  { sku: 'SKU-113', slug: 'gurren-lagann-key-art', title: 'Gurren Lagann — Key Art', category: 'non-manga', price: 33.00, img: 'images/gl.jpg', kicker: 'Non-Manga · Illustration · Limited Print', desc: 'Kamina\'s key art, reprinted at 18×24" — believe in the poster that believes in you.' },
  ...
  { sku: 'SKU-122', slug: 'hardcore-leveling-warrior-formless-swordsmanship', title: 'Hardcore Leveling Warrior — Formless Swordsmanship', category: 'webtoon', price: 28.00, img: 'images/hclw-eg-1.jpg', kicker: 'Webtoon · Game Fantasy · Limited Print', desc: "Moonlight Flash — the formless swordsmanship arc, reprinted at 18×24\" on matte archival stock." },
  { sku: 'SKU-123', slug: 'hardcore-leveling-warrior-original-op', title: 'Hardcore Leveling Warrior — The Original OP Character', category: 'webtoon', price: 28.00, img: 'images/hclw-1.jpg', kicker: 'Webtoon · Game Fantasy · Limited Print', desc: "The Hardcore Leveling Warrior himself, reprinted at 18×24\" on matte archival stock." },
  ...
  { sku: 'SKU-125', slug: 'one-punch-man-saitama-mode', title: 'One Punch Man — Saitama Mode', category: 'seinen', price: 28.00, img: 'images/one-punch-man-1.jpg', kicker: 'Seinen · Comedy-Action · Limited Print', desc: "Saitama cutting loose against Absolute Evil, reprinted at 18×24\" on matte archival stock." },
  { sku: 'SKU-126', slug: 'solo-leveling-part-one-v1', title: 'Solo Leveling — Part One', category: 'webtoon', price: 31.00, img: 'images/solo-leveling-pt1-v1.jpg', kicker: 'Webtoon · Fantasy Action · Limited Print', desc: "A quiet, memory-laced moment from Part One, reprinted at 18×24\" on matte archival stock." },
  { sku: 'SKU-127', slug: 'solo-leveling-part-one-v2', title: 'Solo Leveling — Part One, Guild', category: 'webtoon', price: 31.00, img: 'images/solo-leveling-pt1-v2.jpg', kicker: 'Webtoon · Fantasy Action · Limited Print', desc: "Hunter Sung Jin-Woo forging his own guild, reprinted at 18×24\" on matte archival stock." },
  ...
  { sku: 'SKU-134', slug: 'veil-scene-collage', title: 'Veil — Scene Collage', category: 'non-manga', price: 34.00, img: 'images/veil-1.jpg', kicker: 'Non-Manga · Editorial Collage · Limited Print', desc: 'A full-color scene collage in muted teal, coral, and rose tones, reprinted at 18×24" on matte archival stock.' },
  { sku: 'SKU-135', slug: 'oh-the-places-storefronts', title: 'Oh The Places You\'ll Go — NYC Storefronts', category: 'non-manga', price: 36.00, img: 'images/store-front-poster.jpg', kicker: 'Non-Manga · City Illustration · Limited Print', desc: "A hand-drawn collage of iconic NYC storefronts, reprinted at 18×24\" on matte archival stock." },
...
const SIZE_OPTIONS = [
  ...
  { value: '12x18', label: '12" × 18"', delta: 10 },
  { value: '16x20', label: '16" × 20"', delta: 25 },
  { value: '18x24', label: '18" × 24"', delta: 40 },
];
