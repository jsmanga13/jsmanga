...
const PRODUCTS = [
  ...
  { sku: 'SKU-103', slug: 'kaoru-hana-kaoruko-waguri', title: 'The Fragrant Flower Blooms with Dignity — Kaoruko Waguri', category: 'shounen', price: 25.00, img: 'images/rinka.jpg', kicker: 'Shounen · Drama · Limited Print', desc: 'A character-focused print of Kaoruko Waguri, reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  { sku: 'SKU-104', slug: 'one-piece-east-blue-crew', title: 'One Piece — East Blue Crew', category: 'shounen', price: 25.00, img: 'images/crew-story.jpg', kicker: 'Shounen · Adventure · Limited Print', desc: 'The East Blue saga crew art, reprinted at 18×24" on 260gsm Premium Luster (Satin). Colors matched from the original digital file.' },
  ...
  { sku: 'SKU-137', slug: 'one-piece-alabasta-saga', title: 'One Piece — Alabasta Saga', category: 'shounen', price: 25.00, img: 'images/alabasta-1.jpg', kicker: 'Shounen · Adventure · Limited Print', desc: 'Key art and covers from the Alabasta saga, reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  { sku: 'SKU-138', slug: 'one-piece-tony-tony-chopper', title: 'One Piece — Tony Tony Chopper', category: 'shounen', price: 25.00, img: 'images/chopper-1.jpg', kicker: 'Shounen · Adventure · Limited Print', desc: 'A Chopper-focused cast collage, reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  { sku: 'SKU-139', slug: 'one-piece-loguetown', title: 'One Piece — Loguetown', category: 'shounen', price: 25.00, img: 'images/loguetown-1.jpg', kicker: 'Shounen · Adventure · Limited Print', desc: 'Key art from the Loguetown arc, reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  { sku: 'SKU-140', slug: 'one-piece-nami-arlong-park', title: 'One Piece — Nami & Arlong Park', category: 'shounen', price: 25.00, img: 'images/nami-arlong-1.jpg', kicker: 'Shounen · Adventure · Limited Print', desc: 'Key art from the Arlong Park arc, reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  { sku: 'SKU-141', slug: 'one-piece-skypiea', title: 'One Piece — Skypiea', category: 'shounen', price: 25.00, img: 'images/skypiea-1.jpg', kicker: 'Shounen · Adventure · Limited Print', desc: 'Key art and covers from the Skypiea arc, reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  { sku: 'SKU-142', slug: 'one-piece-zoro-sanji', title: 'One Piece — Zoro & Sanji', category: 'shounen', price: 25.00, img: 'images/zoro-sanji-1.jpg', kicker: 'Shounen · Adventure · Limited Print', desc: 'A Zoro and Sanji character collage, reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  { sku: 'SKU-143', slug: 'one-piece-enies-lobby', title: 'One Piece — Enies Lobby', category: 'shounen', price: 25.00, img: 'images/enies-lobby.jpg', kicker: 'Shounen · Adventure · Limited Print', desc: 'Key art and covers from the Enies Lobby arc, reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  { sku: 'SKU-144', slug: 'one-piece-sea-train', title: 'One Piece — Sea Train', category: 'shounen', price: 25.00, img: 'images/sea-train.jpg', kicker: 'Shounen · Adventure · Limited Print', desc: 'Key art and covers from the Sea Train arc, reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  { sku: 'SKU-145', slug: 'one-piece-robin-i-want-to-live', title: 'One Piece — Nico Robin, I Want To Live', category: 'shounen', price: 25.00, img: 'images/robin-i-want-to-live.jpg', kicker: 'Shounen · Adventure · Limited Print', desc: 'Robin\'s "I want to live" moment from the Enies Lobby arc, reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  { sku: 'SKU-106', slug: 'reborn-vongola-ensemble', title: 'Katekyo Hitman Reborn! — Vongola Ensemble', category: 'non-manga', price: 25.00, img: 'images/r1.jpg', kicker: 'Non-Manga · Illustration · Limited Print', desc: 'The full Vongola family ensemble, reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  { sku: 'SKU-107', slug: 'reborn-battle-colors', title: 'Katekyo Hitman Reborn! — Battle Colors', category: 'non-manga', price: 25.00, img: 'images/r2.jpg', kicker: 'Non-Manga · Illustration · Limited Print', desc: 'Battle-colors art from the Vongola/Varia conflict, reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  { sku: 'SKU-108', slug: 'fragrant-flower-pounding-feeling', title: 'The Fragrant Flower Blooms with Dignity — Pounding Feeling', category: 'shounen', price: 25.00, img: 'images/natsuba.jpg', kicker: 'Shounen · Drama · Limited Print', desc: 'A quiet chapter spread from "Pounding Feeling," reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  { sku: 'SKU-109', slug: 'soul-eater-weapon-ensemble', title: 'Soul Eater — Weapon Ensemble', category: 'non-manga', price: 25.00, img: 'images/soulll.jpg', kicker: 'Non-Manga · Illustration · Limited Print', desc: 'A full weapon-and-meister ensemble print, reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  { sku: 'SKU-110', slug: 'beelzebub-jump-comics-cover', title: 'Beelzebub — Jump Comics Cover', category: 'shounen', price: 25.00, img: 'images/beel.jpg', kicker: 'Shounen · Comedy · Limited Print', desc: 'A Jump Comics cover print, reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  ...
  { sku: 'SKU-112', slug: 'blue-lock-goal', title: 'Blue Lock — Goal', category: 'shounen', price: 25.00, img: 'images/blue-lock.jpg', kicker: 'Shounen · Sports · Limited Print', desc: 'The goal-panel key art, reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  ...
  { sku: 'SKU-114', slug: 'my-hero-academia-one-for-all-vs-all-for-one', title: 'My Hero Academia — Two Symbols of Hope', category: 'shounen', price: 25.00, img: 'images/hero-1.jpg', kicker: 'Shounen · Action · Limited Print', desc: "The climactic All Might and All For One showdown, reprinted at 18×24\" on 260gsm Premium Luster (Satin) — the fight that decided the fate of One For All." },
  { sku: 'SKU-115', slug: 'tokyo-revengers-baji-toman', title: 'Tokyo Revengers — Baji & Toman', category: 'shounen', price: 25.00, img: 'images/baji-1.jpg', kicker: 'Shounen · Delinquent Drama · Limited Print', desc: "Baji Keisuke and the founding of Toman, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  ...
  { sku: 'SKU-117', slug: 'my-hero-academia-one-for-all', title: 'My Hero Academia — One For All', category: 'shounen', price: 25.00, img: 'images/db-1.jpg', kicker: 'Shounen · Action · Limited Print', desc: "United States of Smash — the final battle for One For All, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-118', slug: 'kenichi-mightiest-disciple-ryozanpaku', title: 'Kenichi: The Mightiest Disciple — Ryozanpaku', category: 'shounen', price: 25.00, img: 'images/greatest-disciple-1.jpg', kicker: 'Shounen · Martial Arts · Limited Print', desc: "The masters of Ryozanpaku dojo, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-119', slug: 'kenichi-life-saving-fist', title: 'Kenichi: The Mightiest Disciple — The Life-Saving Fist', category: 'shounen', price: 25.00, img: 'images/kenichi-1.jpg', kicker: 'Shounen · Martial Arts · Limited Print', desc: "Kenichi's training under Ryozanpaku's masters, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-120', slug: 'kenichi-elders-of-ryozanpaku', title: 'Kenichi: The Mightiest Disciple — Elders of Ryozanpaku', category: 'shounen', price: 25.00, img: 'images/senior-disciples-1.jpg', kicker: 'Shounen · Martial Arts · Limited Print', desc: "The senior disciples in full force, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-121', slug: 'kenichi-killing-fist', title: 'Kenichi: The Mightiest Disciple — Killing Fist', category: 'shounen', price: 25.00, img: 'images/shoulders-of-giants-1.jpg', kicker: 'Shounen · Martial Arts · Limited Print', desc: "Standing on the shoulders of giants — Ryozanpaku's toughest fights, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-122', slug: 'hardcore-leveling-warrior-formless-swordsmanship', title: 'Hardcore Leveling Warrior — Formless Swordsmanship', category: 'webtoon', price: 25.00, img: 'images/hclw-eg-1.jpg', kicker: 'Webtoon · Game Fantasy · Limited Print', desc: "Moonlight Flash — the formless swordsmanship arc, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-123', slug: 'hardcore-leveling-warrior-original-op', title: 'Hardcore Leveling Warrior — The Original OP Character', category: 'webtoon', price: 25.00, img: 'images/hclw-1.jpg', kicker: 'Webtoon · Game Fantasy · Limited Print', desc: "The Hardcore Leveling Warrior himself, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-124', slug: 'hinomaru-sumo-waxing-moon', title: 'Hinomaru Sumo — Waxing Moon', category: 'shounen', price: 25.00, img: 'images/hinomaru-1.jpg', kicker: 'Shounen · Sports · Limited Print', desc: "Jougen no Tsuki — Hinomaru's signature throw, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-125', slug: 'one-punch-man-saitama-mode', title: 'One Punch Man — Saitama Mode', category: 'seinen', price: 25.00, img: 'images/one-punch-man-1.jpg', kicker: 'Seinen · Comedy-Action · Limited Print', desc: "Saitama cutting loose against Absolute Evil, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-126', slug: 'solo-leveling-part-one-v1', title: 'Solo Leveling — Part One', category: 'webtoon', price: 25.00, img: 'images/solo-leveling-pt1-v1.jpg', kicker: 'Webtoon · Fantasy Action · Limited Print', desc: "A quiet, memory-laced moment from Part One, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-127', slug: 'solo-leveling-part-one-v2', title: 'Solo Leveling — Part One, Guild', category: 'webtoon', price: 25.00, img: 'images/solo-leveling-pt1-v2.jpg', kicker: 'Webtoon · Fantasy Action · Limited Print', desc: "Hunter Sung Jin-Woo forging his own guild, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-128', slug: 'sakamoto-days-cast', title: 'Sakamoto Days — Cast Collage', category: 'shounen', price: 25.00, img: 'images/sakamoto-1.jpg', kicker: 'Shounen · Action-Comedy · Limited Print', desc: "Sakamoto Days cover art and cast, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-129', slug: 'soul-eater-retrospective', title: 'Soul Eater — Series Retrospective', category: 'shounen', price: 25.00, img: 'images/soul-eater-2.jpg', kicker: 'Shounen · Supernatural · Limited Print', desc: "Magazine covers and cast art from across the Soul Eater run, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-130', slug: 'tokyo-revengers-takemichi-hina', title: 'Tokyo Revengers — Takemichi & Hina', category: 'shounen', price: 25.00, img: 'images/takehina-1.jpg', kicker: 'Shounen · Delinquent Drama · Limited Print', desc: "Takemichi and Hinata's story, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-131', slug: 'tokyo-revengers-winter-first-division', title: 'Tokyo Revengers — Winter Arc, First Division', category: 'shounen', price: 25.00, img: 'images/tr-winter-first-1.jpg', kicker: 'Shounen · Delinquent Drama · Limited Print', desc: "The Winter arc's First Division showdown, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-132', slug: 'tokyo-revengers-winter-black-dragons', title: 'Tokyo Revengers — Winter Arc, Black Dragons', category: 'shounen', price: 25.00, img: 'images/tr-winter-secondo-1.jpg', kicker: 'Shounen · Delinquent Drama · Limited Print', desc: "Takemichi against the Black Dragons, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-133', slug: 'tokyo-revengers-winter-save-hakkai', title: 'Tokyo Revengers — Winter Arc, Save Hakkai', category: 'shounen', price: 25.00, img: 'images/tr-winter-trente-1.jpg', kicker: 'Shounen · Delinquent Drama · Limited Print', desc: "Toman's race to save Hakkai, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-134', slug: 'veil-scene-collage', title: 'Veil — Scene Collage', category: 'non-manga', price: 25.00, img: 'images/veil-1.jpg', kicker: 'Non-Manga · Editorial Collage · Limited Print', desc: 'A full-color scene collage in muted teal, coral, and rose tones, reprinted at 18×24" on 260gsm Premium Luster (Satin).' },
  { sku: 'SKU-135', slug: 'oh-the-places-storefronts', title: 'Oh The Places You\'ll Go — NYC Storefronts', category: 'non-manga', price: 25.00, img: 'images/store-front-poster.jpg', kicker: 'Non-Manga · City Illustration · Limited Print', desc: "A hand-drawn collage of iconic NYC storefronts, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
  { sku: 'SKU-136', slug: 'air-gear-storm-riders', title: 'Air Gear — Storm Riders', category: 'shounen', price: 25.00, img: 'images/air-gear-1.jpg', kicker: 'Shounen · Action-Sports · Limited Print', desc: "Ikki and the Storm Riders in flight, reprinted at 18×24\" on 260gsm Premium Luster (Satin)." },
];
...
const ABOUT_WORD_PARAGRAPHS = [
  'Each print is an original 1 of 1 from all sources related to the series — printed on 260gsm Premium Luster (Satin), we offer the highest quality prints on the market. All hand-numbered, never reprinted once an edition sells out.',
  ...
  'We’re an independent, artist-made print studio — not an official publisher partner. We hunt down the highest-resolution source we can find for every panel instead of going through resellers, so you get a clean, carefully made print instead of a bootleg.',
  'Every panel starts as the highest-resolution digital file we can track down from officially published volumes and covers — never a blurry scan pulled off the internet. That file is cleaned and color-corrected digitally at full resolution, so the linework stays crisp and the color stays true no matter how large the final print is.',
...
function renderCartPage() {
  ...
  if (cartStep === 'cart') {
    ...
    summaryMount.innerHTML = `
      ...
      <div class="cart-note">Printed to order on 260gsm Premium Luster (Satin)</div>
    `;
